...
export const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-white/95 dark:bg-black/95 backdrop-blur-sm shadow-md dark:shadow-[0_4px_6px_-1px_rgba(255,255,255,0.05)] py-4 px-6 z-20 overflow-hidden transition-all duration-300 ease-in-out ${
