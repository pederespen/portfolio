              ...
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      d="M10 4a1 1 0 100 2 1 1 0 000-2zm0 7a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
            ...
            <div className="mt-8 flex space-x-4">
              ...
              <a href="#" className="text-gray-600 hover:text-blue-500">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h-2v-6h2v6zm-1-7a1 1 0 100-2 1 1 0 000 2zm8 7h-2v-4c0-.6-.4-1-1-1s-1 .4-1 1v4h-2v-6h2v1.2c.5-.8 1.6-1.4 2.5-1.4 1.6 0 2.5 1.4 2.5 3v3.2z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
